...
<div style='text-align: justify; font-style: italic;'>
    <p><b>Club de Licores</b> es una aplicación interactiva que permite explorar una amplia variedad de recetas, conocer sus ingredientes, ajustar las cantidades según el número de personas o el volumen deseado, y descubrir datos curiosos, poemas, imágenes e incluso canciones asociadas a cada trago.</p>
